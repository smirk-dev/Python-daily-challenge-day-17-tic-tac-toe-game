...
**Day 17 of #dailylearning** – A modern Tic-Tac-Toe game built using Pygame, featuring an AI opponent with three difficulty levels: Easy, Intermediate, and Hard.

## 📝 About the Project
This is a classic Tic-Tac-Toe game with a visually appealing interface and AI-driven opponent. The AI uses:
- **Random moves** (Easy mode)
- **Smart heuristics** (Intermediate mode)
- **Minimax algorithm** (Hard mode) for unbeatable gameplay.

## 🚀 Features
- **Beautiful Gradient UI** 🎨
- **Smooth Animations & Hover Effects**
- **Three AI Difficulty Levels**
- **Game Sound Effects** 🔊 (if available)
- **Dynamic Menu System**
